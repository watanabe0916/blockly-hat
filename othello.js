...
*/
const evaluate8 = [];
evaluate8[0] = [0,0,0,0,0,0,0,0];
evaluate8[1] = [0,0,0,0,0,0,0,0];
evaluate8[2] = [0,0,0,0,0,0,0,0];
evaluate8[3] = [0,0,0,0,0,0,0,0];
evaluate8[4] = [0,0,0,0,0,0,0,0];
evaluate8[5] = [0,0,0,0,0,0,0,0];
evaluate8[6] = [0,0,0,0,0,0,0,0];
evaluate8[7] = [0,0,0,0,0,0,0,0];
...
//スコアを返す
function boardscore(data, evalTurn){
  const COLOR =  evalTurn ? BLACK : WHITE;
  const opponentCOLOR = evalTurn ? WHITE : BLACK; 
  if(data.length != cells){
    window.alert("配列のサイズを確認してください");
    return;
  }
...
function othelloCPUTurn(algoArgFromHat, evalArgFromHat) {
  ...
  const GROUP_COORDS = {
    ...
    C: [[2,2],[2,5],[5,2],[5,5]],
    D: [[0,3],[0,4],[3,0],[4,0],[3,7],[4,7],[7,3],[7,4]],
    E: [[2,3],[2,4],[3,2],[4,2],[3,5],[4,5],[5,3],[5,4],[3,3],[3,4],[4,3],[4,4]],
    F: [[1,2],[1,3],[1,4],[1,5],[2,1],[2,6],[3,1],[3,6],[4,1],[4,6],[5,1],[5,6],[6,2],[6,3],[6,4],[6,5]],
    G: [[0,1],[1,0],[0,6],[1,7],[6,0],[7,1],[6,7],[7,6]],
    H: [[1,1],[1,6],[6,1],[6,6]]
  };
